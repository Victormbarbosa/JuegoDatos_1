...
import static lab_final_valeriaosoriovictorbarbosa.Decision.dia;
import static lab_final_valeriaosoriovictorbarbosa.Inicio.pr;
...
public class Historia extends javax.swing.JFrame {
    ...
    static ListaPila l = new ListaPila();
    ...
    public Historia() throws IOException {
        ...
        progresohistoria.setMinimum(0);
        progresohistoria.setMaximum(100);
...
//        in.setLocationRelativeTo(null);
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
        ...
        String cadena = in.desicion + ":" + in.nick + ":" + in.orden + ":" + pr + ":";
        if (save.equals("")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Historia.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    Logger.getLogger(Historia.class
